...
//    e.preventDefault()
//    $('.assistant__item--min').toggleClass('assistant__item--min-more')
//  })
 ...
 $('.header__lang-images').on('click', function (e) {
   e.preventDefault()
   $('.header__lang-arr').toggleClass('header__lang-arr--active');
 })
 $('.header__lang-arr').on('click', function (e) {
   e.preventDefault()
   $('.header__lang-arr').toggleClass('header__lang-arr--active');
 })
